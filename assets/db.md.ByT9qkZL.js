import{_ as n,c as a,o as p,ae as e}from"./chunks/framework.BHrE6nLq.js";const A=JSON.parse('{"title":"Database Creation Statement","description":"","frontmatter":{},"headers":[],"relativePath":"db.md","filePath":"db.md"}'),l={name:"db.md"};function T(t,s,N,L,i,c){return p(),a("div",null,s[0]||(s[0]=[e(`<h1 id="database-creation-statement" tabindex="-1">Database Creation Statement <a class="header-anchor" href="#database-creation-statement" aria-label="Permalink to &quot;Database Creation Statement&quot;">​</a></h1><p>The following are the SQL statements for creating the database and table structures. You can modify them as needed.</p><div class="language-mysql vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">mysql</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>USE mysql;</span></span>
